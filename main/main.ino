    ...
    void)
{
    ...
    g_bZoneLiftHill.init(
        CONSTANTS::STATION_EXIT_PIN,
        CONSTANTS::LIFT_HILL_POSITION_PIN,
    ...
    g_bZoneStation.init(
        CONSTANTS::Pins::TRANSFER_TRACK_EXIT_PIN,
        CONSTANTS::Pins::STATION_POSITION_PIN,
        CONSTANTS::Pins::STATION_EXIT_PIN,
        &g_bZoneLiftHill,
        &g_motorDriver);
    xTaskCreate(
        taskLauncher,
